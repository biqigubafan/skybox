        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                {   
                    ...
                    float finalNoise = saturate(noise1 * noise2) * 3 * saturate(i.worldPos.y);//低处没有云，乘y，还没有结束，因为只有一个层次
                    ...
                    sunsetColoured=lerp(sunsetColoured, sunset1+sunset2, saturate(abs(_WorldSpaceLightPos0.y)));
